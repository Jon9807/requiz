...
const API_BASE = "http://localhost/re-quiz-app/backend";
...
const ConfirmDialog = ({ show, title, message, onConfirm, onCancel }) => {
  ...
  return (
    ...
    >
      <div className="neon-border p-4 bg-dark rounded" style={{ maxWidth: "400px", width: "90%" }}>
        ...
        <div className="d-flex justify-content-end gap-2">
          ...
          <button className="btn btn-sm btn-outline-light" onClick={onCancel}>
            No
          </button>
        </div>
      </div>
...
const History = () => {
  ...
  return (
    <div className="container mt-5 text-light">
      <h2 className="mb-4">My Quiz History</h2>
