...
const AdminCreateQuiz = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost/re-quiz-app/backend/index.php?action=get_subcategories&category_id=${quizData.category_id}`)
      .then(res => res.json())
  ...
  const handleSubmit = e => {
    ...
    const payload = {
      ...
      subcategory_id: quizData.subcategory_id ? parseInt(quizData.subcategory_id) : null,
      is_public: parseInt(quizData.is_public),
    };

    fetch("http://localhost/re-quiz-app/backend/index.php?action=admin_create_quiz", {
      method: "POST",
      headers: {
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="row g-3">
        <div className="col-12">
          <label htmlFor="quizName" className="form-label text-light">Quiz Name</label>
          <input
            id="quizName"
            name="name"
            type="text"
        ...
        <div className="col-12">
          <label htmlFor="quizDescription" className="form-label text-light">Description</label>
          <textarea
            id="quizDescription"
            name="description"
            rows={2}
        ...
        <div className="col-md-6">
          <label htmlFor="subcategory_id" className="form-label text-light">Subcategory (optional)</label>
          <select
            id="subcategory_id"
            name="subcategory_id"
            className="form-select form-select-sm"
        ...
        <div className="col-md-6">
          <label htmlFor="is_public" className="form-label text-light">Visibility</label>
          <select
            id="is_public"
            name="is_public"
            className="form-select form-select-sm"
